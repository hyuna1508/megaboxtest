...
<body>
	...
	<div class="bdy">
		<div class="container">
			<form action="updatepg" name="Board" method="post">
					<div class="form-group">
					  <label for="exampleInputEmail1">제목</label>
					  <input type="text" class="form-control" name='title' id="exampleInputEmail1" value='<c:out value="${dao.title}"/>' placeholder="제목을 입력하세요">
					</div>
					<div class="form-group">
					  <label for="exampleInputEmail1">작성자</label>
					  <input type="text" class="form-control"name='writer'  id="exampleInputEmail1" placeholder="작성자명을 입력하세요">
					</div>
					<div class="form-group">
						  <label for="exampleInputPassword1">내용</label>
						  <textarea rows="30" cols="10" class="form-control" name='content' id="exampleInputPassword1" placeholder="내용을 입력하세요"><c:out value="${dao.content}" /></textarea>
